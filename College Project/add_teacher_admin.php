    ...
    //echo $num;
            ...
            if($result2){
              ...
              echo "<h3 style='text-align:center'>You Can See The Details By Clicking On See Already Registered Teachers.</h3>";
                    ...
                    if($sub5sem=="NULL"){
                    $sql="INSERT INTO `teacher_subject` (`Reg Number`,`Teacher Name`,`5_sem`,`6_sem`) VALUES ('$regno','$name',NULL,'$sub6sem')";}

                    else if($sub6sem=="NULL"){
                      $sql="INSERT INTO `teacher_subject` (`Reg Number`,`Teacher Name`,`5_sem`,`6_sem`) VALUES ('$regno','$name','$sub5sem',NULL)";}
